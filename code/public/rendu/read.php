    ...
    <table>
        ...
        ?>
                <tr>
                    ...
                    <td><?= $joueur['poste'] ?></td>
                    <td><a href="details.php?id=<?= $joueur['id'] ?>">Voir</a>  <a href="update.php?id=<?= $joueur['id'] ?>">Modifier</a>  <a href="delete.php?id=<?= $joueur['id'] ?>">Supprimer</a></td>
                </tr>
        <?php
            }
        ?>
